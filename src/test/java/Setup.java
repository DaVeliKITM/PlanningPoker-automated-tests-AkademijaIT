...
public class Setup {
    ...
    public static void waitForElementToAppearMessage(By elementSelector) {
        new WebDriverWait(Setup.browser, Duration.ofSeconds(20),Duration.ofMillis(50)).until(e -> e.findElement(elementSelector));
    }
